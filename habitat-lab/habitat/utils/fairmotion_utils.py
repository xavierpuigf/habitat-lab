...
import torch
from motion_converter import motion,amass,conversions
...
class MotionData:
    """        joint_map = {}
        ...
        joint_map["ltoe"] = "m_avg_L_Foot"
        joint_map["rtoe"] = "m_avg_R_Foot"
        

        # breakpoint()
        inv_map = {v: k for k, v in joint_map.items()}Q =
...
class AmassHelper:
    ...
    def convert_CMUamass_single_pose(
        ...
        joint_map["ltoe"] = "m_avg_L_Foot"
        joint_map["rtoe"] = "m_avg_R_Foot"
        joint_map["lhand"] = "m_avg_L_Hand" 
        joint_map["rhand"] = "m_avg_R_Hand"
        ...
        for model_link_id in range(len(joint_info)):
            ...
            if joint_name not in pose.skel.index_joint:
